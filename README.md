## pyquaternion (melodic) - 0.9.6-1

The packages in the `pyquaternion` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic pyquaternion --edit` on `Thu, 12 Mar 2020 20:46:48 -0000`
